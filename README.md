...
This package checks if the _Laravel application resources_ are running as they should and creates a service status panel. It has the following main points:
