<template>
    <div :class="'col-md-'+resource.columnSize ">
        <div :class="'btn btn-block target-card '+colorClassBackground+' '+resource.style.buttonLines"
             :title="resource.name"
        ...
        >
            <div v-if="resource.style.buttonLines === 'multi'">
                <p class="title">
                    ...
                    <span :class="'question-mark '+colorClass" @click="$emit('show-result')">
                ...
                <div class="row d-flex">
                    <div class="col-12 text-left">
                        <h3 @click="$emit('check-resource')" :class="colorClass">
...
export default {
    ...
    computed: {
        colorClass() {
            return !this.target.result ? 'color-neutral' : (this.target.result.healthy ? 'color-success' : 'color-danger');
        },
